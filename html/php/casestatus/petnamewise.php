...
<h2>CASE STATUS BY PETITINER NAME</h2>
  <br><br>
 <label for="number" id="number"> petioner name </label>
<input name= "petname" type="text"><br/>
...
if(isset($_POST['search'])){
    $id1 = $_POST['petname'];
    $id2 = $_POST['year'];
    $query = "SELECT * FROM orders where  PETNAME = '$id1' AND YEARREG = '$id2' ";
