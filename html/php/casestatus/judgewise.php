...
<h2>CASE STATUS BY JUDGE NAME</h2>
  <br><br>
 <label for="number" id="number"> judge name </label>
<input name= "judgename" type="text"><br/>
...
if(isset($_POST['search'])){
    $id1 = $_POST['judgename'];
    $id2 = $_POST['year'];
    $query = "SELECT * FROM orders where  JUDGENAME = '$id1' AND YEARREG = '$id2' ";
